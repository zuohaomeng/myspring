...
public class GPDispatcherServlet extends HttpServlet{
    ...
    private void doLoadConfig(String contextConfigLocation) {
        ...
        System.out.println(this.getClass().getClassLoader().getResource("contextConfigLocation"));
        System.out.println("classloader:    "+this.getClass().getClassLoader().getResource(""));
        try {
