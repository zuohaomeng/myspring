...
import com.meng.zspring.framework.annotation.ZRequestParam;
...
public class ZHandlerAdapter {
    public boolean supports(Object handler){ return (handler instanceof ZHandlerMapping);}
    ...
    public ZModelAndView handle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception{
        ...
        //给有HttpServletRequest注解的参数赋值
        if(paramIndexMapping.containsKey(HttpServletRequest.class.getName())) {
            int reqIndex = paramIndexMapping.get(HttpServletRequest.class.getName());
            paramValues[reqIndex] = request;
        }

        //给有HttpServletResponse注解的参数赋值
